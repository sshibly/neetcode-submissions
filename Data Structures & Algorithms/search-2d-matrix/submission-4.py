class Solution:
    def searchMatrix(self, matrix: List[List[int]], target: int) -> bool:
        ...
        # if we don't find a valid row
        # - the element is smaller than every element in matrix or
        # - element is larger than every element in matrix
        if not (top <= bot):
            return False
        ...
        # if we didn't find an element in the valid row
        return False
